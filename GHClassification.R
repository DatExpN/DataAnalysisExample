...
# жанр фильма: фильмы с большей длительностью и жанром Other (по сравнению с криминалом и драмой) с наибольшей вероятностью соберут большую кассу. 
# Изменение жанра с Other на криминал или драму уменьшает вероятность получения высокой выручки.
...
library(ROCR)
pred <- prediction(pred_logit, valid.df$Revenue)
...
unlist(slot(performance(pred, "auc"), "y.values")) # Значение AUC 0.59
...
# Далее для решения задачи предсказания большой выручки попробуем алгоритм Random Forest.
